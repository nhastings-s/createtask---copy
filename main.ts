namespace SpriteKind {
    ...
    export const swordcharacter2 = SpriteKind.create()
}
...
scene.onOverlapTile(SpriteKind.swordcharacter, sprites.dungeon.purpleOuterSouth2, function (sprite4, location3) {
    checkScore()
})
...
sprites.onOverlap(SpriteKind.swordcharacter, SpriteKind.Projectile, function (sprite, otherSprite) {
    info.changeLifeBy(-1)
})
sprites.onOverlap(SpriteKind.swordcharacter, SpriteKind.Enemy, function (sprite2, otherSprite) {
    if (Person == true) {
        otherSprite.destroy()
        pause(200)
...
scene.onOverlapTile(SpriteKind.Player, sprites.dungeon.purpleSwitchDown, function (sprite3, location2) {
    checkScore()
})
function swordcharacterenemySetup (bool2: boolean) {
    Enemyevil = sprites.create(EnemieList._pickRandom(), SpriteKind.Enemy)
    tiles.placeOnRandomTile(Enemyevil, sprites.dungeon.floorDark0)
}
function Next_level (level_1_number: number) {
    if (currentLevel == 1) {
        ...
        tiles.placeOnRandomTile(swordmainCharacter, sprites.dungeon.stairWest)
    } else if (currentLevel == 3) {
        info.stopCountdown()
        info.startCountdown(60)
        tiles.setCurrentTilemap(tilemap`level4`)
        tiles.placeOnRandomTile(swordmainCharacter, sprites.builtin.field0)
    }
}
...
scene.onOverlapTile(SpriteKind.swordcharacter, sprites.builtin.field1, function (sprite3, location2) {
    game.over(true)
})
scene.onOverlapTile(SpriteKind.swordcharacter, sprites.dungeon.purpleSwitchDown, function (sprite4, location3) {
    checkScore()
})
function swordmaincharactersetup2 () {
    swordmainCharacter = sprites.create(img`
        ......ffff..............
        ....fff22fff............
        ...fff2222fff...........
